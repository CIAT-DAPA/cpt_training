...
names_selec <-Map(function(x,y) paste0(x,"/CFSV2_r/",substr(y,1,nchar(y))) ,folders,names_x)
...
path_x_2 <- lapply(folders,function(x)list.files(paste0(x,"/CFSV2_r"),full.names = T))
